...
function createPopUp(text, x, y) {
    ...
    <div id="translateAnki" style="top: ${y}px; left: ${x}px;">
        ...
        <br />
        <br />
        <svg class="addToDeckIcon" fill="#000000" width="52" height="52" version="1.1" id="addToDeckAnki" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
